...
/* Used peripherals */
#define DECK_UART1  (1<<0)
#define DECK_UART2  (1<<1)
#define DECK_SPI    (1<<2)
#define DECK_TIMER3 (1<<3)

/* Used GPIO */
#define DECK_PC11 (1<<0)
#define DECK_RX1  (1<<0)
#define DECK_PC10 (1<<1)
#define DECK_TX1  (1<<1)
#define DECK_PB7  (1<<2)
#define DECK_SDA  (1<<2)
#define DECK_PB6  (1<<3)
#define DECK_SCL  (1<<3)
#define DECK_PB8  (1<<4)
#define DECK_IO_1 (1<<4)
#define DECK_PB5  (1<<5)
#define DECK_IO_2 (1<<5)
#define DECK_PB4  (1<<6)
#define DECK_IO_3 (1<<6)
#define DECK_PC12 (1<<7)
#define DECK_IO_4 (1<<7)
#define DECK_PA2  (1<<8)
#define DECK_TX2  (1<<8)
#define DECK_PA3  (1<<9)
#define DECK_RX2  (1<<9)
#define DECK_PA5  (1<<10)
#define DECK_SCK  (1<<10)
#define DECK_PA6  (1<<11)
#define DECK_MISO (1<<11)
#define DECK_PA7  (1<<12)
#define DECK_MOSI (1<<12)
