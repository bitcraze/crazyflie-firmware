...
STFLAGS_CF2 = -DSTM32F4XX -DSTM32F40_41xxx -DHSE_VALUE=8000000 -DUSE_STDPERIPH_DRIVER -DPLATFORM_CF2 -D__FPU_PRESENT=1
...
CFLAGS += -DBOARD_REV_$(REV) -DSENSORS_TYPE=$(SENSORS) -DESTIMATOR_TYPE=$(ESTIMATOR) -DCONTROLLER_TYPE=$(CONTROLLER) -DPOWER_DISTRIBUTION_TYPE=$(POWER_DISTRIBUTION)
