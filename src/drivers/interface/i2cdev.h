...
#define DECKCTRL_RESET_I2C_ADDRESS     0x41
#define DECKCTRL_LISTEN_I2C_ADDRESS    0x42
#define DECKCTRL_DEFAULT_I2C_ADDRESS   0x43
#define DECKCTRL_START_I2C_ADDRESS     0x44 // + CONFIG_DECK_BACKEND_DECKCTRL_MAX_DECKS
