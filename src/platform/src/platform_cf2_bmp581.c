 ...
 *
 * Platform functionality for the CF2 platform with BMP581 barometer
 */
...
static platformConfig_t configs[] = {
  ...
  {
    .deviceType = "CF21",
    .deviceTypeName = "Crazyflie 2.1 BMP581",
    .sensorImplementation = SensorImplementation_bmi088_bmp5xx,
