...
// TA: Start bit time changed to half from 3/4. I don't understand why 3/4 was used.
...
static uint8_t suart_getc_(uint8_t *bt)
{
    ...
    // TA: Added to prevent most interruption during read
    watchdogReset();
    taskENTER_CRITICAL();
...
static void suart_putc_(uint8_t *tx_b)
{
    ...
    // TA: Added to prevent most interruption during write
    watchdogReset();
    taskENTER_CRITICAL();
