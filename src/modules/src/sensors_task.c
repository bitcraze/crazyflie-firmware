...
#ifdef PLATFORM_CF1
#error sensors_task is only compatible with the Crazyflie 2.0 // due to the IMU initialization
#endif
...
static Axis3i64 gyroBiasSampleSum = {0};
static float accScaleSum = 0;
static float accScale = 1;
#ifdef IMU_GYRO_BIAS_CALCULATE_STDDEV
static Axis3f gyroBiasStdDev = {0};
static Axis3i64 gyroBiasSampleSumSquares = {0};
#endif
