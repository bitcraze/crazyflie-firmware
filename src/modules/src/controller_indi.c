 ...
 */
PARAM_ADD_CORE(PARAM_FLOAT, thrust_threshold, &thrust_threshold)
/**
 * @brief INDI bounding for control input 
 */
PARAM_ADD_CORE(PARAM_FLOAT, bound_ctrl_input, &bound_control_input)
/**
 * @brief INDI  Attitude Roll control Propertional Gain
 */
PARAM_ADD_CORE(PARAM_FLOAT, roll_kp, &roll_kp)
/**
 * @brief INDI Attitude Pitch control Propertional Gain
 */
PARAM_ADD_CORE(PARAM_FLOAT, pitch_kp, &pitch_kp)
/**
 * @brief INDI Attitude Yaw control Propertional Gain
 */
PARAM_ADD_CORE(PARAM_FLOAT, yaw_kp, &yaw_kp)
/**
 * @brief INDI Controller effectiveness G1 p
 */
PARAM_ADD_CORE(PARAM_FLOAT, g1_p, &indi.g1.p)
/**
 * @brief INDI Controller effectiveness G1 q
 */
PARAM_ADD_CORE(PARAM_FLOAT, g1_q, &indi.g1.q)
/**
 * @brief INDI Controller effectiveness G1 r
 */
PARAM_ADD_CORE(PARAM_FLOAT, g1_r, &indi.g1.r)
/**
 * @brief INDI Controller effectiveness G2
 */
PARAM_ADD_CORE(PARAM_FLOAT, g2, &indi.g2)
/**
 * @brief INDI Error acceleration for attitude control p
 */
PARAM_ADD_CORE(PARAM_FLOAT, ref_err_p, &indi.reference_acceleration.err_p)
/**
 * @brief INDI Error acceleration for attitude control q
 */
PARAM_ADD_CORE(PARAM_FLOAT, ref_err_q, &indi.reference_acceleration.err_q)
/**
 * @brief INDI Error acceleration for attitude control r
 */
PARAM_ADD_CORE(PARAM_FLOAT, ref_err_r, &indi.reference_acceleration.err_r)
/**
 * @brief INDI Reference acceleration for attitude control p
 */
PARAM_ADD_CORE(PARAM_FLOAT, ref_rate_p, &indi.reference_acceleration.rate_p)
/**
 * @brief INDI Reference acceleration for attitude control q
 */
PARAM_ADD_CORE(PARAM_FLOAT, ref_rate_q, &indi.reference_acceleration.rate_q)
/**
 * @brief INDI Reference acceleration for attitude control r
 */
PARAM_ADD_CORE(PARAM_FLOAT, ref_rate_r, &indi.reference_acceleration.rate_r)
/**
 * @brief INDI actuator dynamics parameter p
 */
PARAM_ADD_CORE(PARAM_FLOAT, act_dyn_p, &indi.act_dyn.p)
/**
 * @brief INDI actuator dynamics parameter q
 */
PARAM_ADD_CORE(PARAM_FLOAT, act_dyn_q, &indi.act_dyn.q)
/**
 * @brief INDI actuator dynamics parameter r
 */
PARAM_ADD_CORE(PARAM_FLOAT, act_dyn_r, &indi.act_dyn.r)
/**
 * @brief INDI Filtering for the raw angular rates
 */
PARAM_ADD_CORE(PARAM_FLOAT, filt_cutoff, &indi.filt_cutoff)
/**
 * @brief INDI Filtering for the raw angular rates
 */
PARAM_ADD_CORE(PARAM_FLOAT, filt_cutoff_r, &indi.filt_cutoff_r)
/**
