...
{
  return DECK_MEM_MAX_SIZE * (DECK_MAX_COUNT + 1);
}
TESTABLE_STATIC bool handleMemRead(const uint32_t memAddr, const uint8_t readLen, uint8_t *buffer);
TESTABLE_STATIC bool handleMemWrite(const uint32_t memAddr, const uint8_t writeLen,
...
static bool handleInfoSectionRead(const uint32_t memAddr, const uint8_t readLen, uint8_t *buffer,
                                  const int nrOfDecks)
{
  uint32_t index = 0;
...
static bool handleDeckSectionRead(const uint32_t memAddr, const uint8_t readLen, uint8_t *buffer,
                                  const int deckNr, const MemSelector selector)
{
  bool result = false;
...
static void handleCommandForDevice(const DeckMemDef_t *memoryDef, const uint32_t adr,
                                   const uint8_t value)
{
...
static bool handleCommandSectionWrite(const uint32_t memAddr, const uint8_t writeLen,
                                      const uint8_t *buffer, const int nrOfDecks)
{
...
static bool handleDeckSectionWrite(const uint32_t memAddr, const uint8_t writeLen,
                                   const uint8_t *buffer, const int deckNr, const MemSelector selector)
{
  bool result = false;
