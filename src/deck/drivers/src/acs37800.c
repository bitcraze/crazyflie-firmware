...
{
  return i2cdevReadReg8(I2C1_DEV, ACS37800_I2C_ADDRESS, reg, 4, (uint8_t *)data32);
}

static bool asc37800Write32(uint8_t reg, uint32_t data32)
{
  return i2cdevWriteReg8(I2C1_DEV, ACS37800_I2C_ADDRESS, reg, 4, (uint8_t *)&data32);
}
...
static void asc37800Init(DeckInfo *info)
{
  ...
  if (i2cdevWrite(I2C1_DEV, ACS37800_I2C_ADDRESS, 1, (uint8_t *)&dummy))
  {
