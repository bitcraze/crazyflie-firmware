 ...
 * If you want to use SDIO 1-bit communication, set defines below in your tm_defines.h file:
 * 
@verbatim
 ...
 * 
 * Or, if you want to use SPI communication, you have to add lines below in your tm_defines.h file
 *	
@verbatim
 ...
 * If you want to change SPI pins, you have to set these defines in your tm_defines.h file:
 * 
@verbatim
...
@endverbatim
 *
 * Like I said before, these 2 pins are disabled by default. If you want to use it, you have to add 2 lines in your tm_defines.h file:
 *
@verbatim
 ...
 *
 * Add lines below to your tm_defines.h file only if you want to overwrite default pin settings:
 *
@verbatim
//Default CD pin			
 ...
 * 
 * By default, function returns 0, but if you want to create your own function, you have to set defines in tm_defines.h file:
 * 
@verbatim
...
@endverbatim 
 * 
 * After you have your files included in project, open project's tm_defines.h file and add line below:
 * 
@verbatim
 ...
 * 
 * If you want to use SD card and USB storage at the same time for some reason, you have to enable SD card functionality back. Add lines below in your tm_defines.h file:
 * 
@verbatim
 ...
 *
 * To enable this feature, you will have to open tm_defines.h file and add define:
 *
@verbatim
//Enable SDRAM
 ...
 *
 * To use all available data sources (physical drivers) for FATFS, you will have to open tm_defines.h file, and add these defines:
 *
@verbatim
