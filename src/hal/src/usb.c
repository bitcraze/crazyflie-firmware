...
//#define CF_CMD_EP                   0x84  /* EP2 for CDC commands */

#define VCP_IN_EP                   0x82  /* EP3 for data IN */
#define VCP_OUT_EP                  0x02  /* EP3 for data OUT */
#define VCP_CMD_EP                  0x83  /* EP4 for command */
