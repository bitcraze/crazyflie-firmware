...
static void dwGetDataMockCallback(dwDevice_t *actualDev, uint8_t *data,
                                  unsigned int actualDataLength, int cmock_num_calls)
{
...
void dwGetData_ExpectAndCopyData(dwDevice_t *expDev, const packet_t *rxPacket,
                                 unsigned int expDataLength)
{
...
static void dwGetTransmitTimestampMockCallback(dwDevice_t *actualDev, dwTime_t *time,
    int cmock_num_calls)
{
...
void dwGetTransmitTimestamp_ExpectAndCopyData(dwDevice_t *expDev, const dwTime_t *time)
{
  ...
  memcpy(&dwGetTransmitTimestampContexts[dwGetTransmitTimestampMockCallIndex].time, time,
         sizeof(dwTime_t));
...
static void dwGetReceiveTimestampMockCallback(dwDevice_t *actualDev, dwTime_t *time,
    int cmock_num_calls)
{
...
void dwGetReceiveTimestamp_ExpectAndCopyData(dwDevice_t *expDev, const dwTime_t *time)
{
  ...
  memcpy(&dwGetReceiveTimestampContexts[dwGetReceiveTimestampMockCallIndex].time, time,
         sizeof(dwTime_t));
