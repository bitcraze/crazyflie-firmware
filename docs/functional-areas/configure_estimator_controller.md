...
It is possible to force the use of a specific estimator at compile time by setting `ESTIMATOR`, see [Configue the build](/building-and-flashing/configure_build/).
...
It is possible to force the use of a specific controller at compile time by setting `CONTROLLER`, see [Configue the build](/building-and-flashing/configure_build/).
