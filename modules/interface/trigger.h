...
typedef struct {
    ...
    float threshold;          /* The threshold against which to compare the test value with the trigger function. */
    ...
    uint32_t testCounter;     /* This counter will be incremented for each consecutive test the tested value is within the threshold. */
